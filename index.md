...
¹ MTD can interact with aggravators: Pharyngitis (as from concomitant MCAS, or from Reflux), Nasal Blockage, Voicebox Lesions, Conflict Over Speaking Out (COSO), Autism
...
Thus emerges a broader theory: the maladaptive control state of MTD, once established, may extend beyond the larynx to overwhelm the brain's more generalized systems of fine motor regulation. These may include global posture, breathing, cervical stabilization and spine health, and even the extraocular muscles, whose fatigue or mis‑signaling frequently triggers sensory overload and crashes in ME/CFS. All these sensitive subsystems may share a limited processing resource pool and are also prone to early failure in mitochondrial damage, a hallmark of of ME/CFS pathophysiology. If these systems overdraw from their shared pool of finite reserves, then their failures may co‑occur—a phenomenon named here as Pseudo‑PEM. Resting one subsystem could help others recover. For example, it remains to be studied whether ME/CFS patients, who frequently experience visual sensitivity, can increase functional capacity by performing movements while resting the high-bandwidth visual signal through eye-blocking, which additionally quiets the vestibulo-ocular reflex.

Articulation of the vocal muscles for speech and singing is included among the most demanding feedback-driven control problems, via the "tonic servo-reflex system" within the larynx [cite https://www.organscigroup.us/articles/doi10.17352-2455-1759.000065-aor.php]. MTD pathology is possible because of the reliance of speech on feedback from the larynx and hearing. Although normal phonation can proceed even while all sensory feedback is blocked, evidence indicates this feedback mainly serves to calibrate persistent adjustments to vocal behaviors over time. Thus, MTD is not just a fleeting reflex as observed under videostroboscopy (seen only during phonation or its anticipation), but a durable, maladaptive learned state [cite https://www.organscigroup.us/articles/doi10.17352-2455-1759.000065-aor.php] - an altered baseline that perpetually shapes laryngeal recruitment, even outside active speech, and chronically disrupts neck and CCJ dynamics.

The PGP model posits that the underlying sensory feedback abnormality driving MTD is a continuous, “always on” maladaptive state—a learned disruption in motor control that affects laryngeal muscle recruitment even outside active phonation. This persistent neuromuscular state plausibly accounts for the chronic overactivation of neck and craniocervical muscles known to cause pain and dysfunction in ME/CFS. Therefore, the PGP model positions MTD not as a side feature but as an essential bottleneck in the cascade, suggesting that treating MTD could interrupt or reverse downstream consequences like dysautonomia, cervical instability, and chronic pain.
...
Whether causative of neck strain or not, both the pharynx and the larynx are positioned to be affected by neck strain. Innervation of the pharynx depends on the CCJ's integrity, potentially creating a feedback loop in CCJ dysfunction; the pharyngeal plexus, which innervates the pharyngeal muscles, has branches entering the posterior pharyngeal wall at the C3/C4 vertebral levels. In CCI, the compression of cranial nerves and the brainstem (as in Cervical-Medullary Syndrome) can manifest as a variety of ENT-related complaints, including swallowing difficulties, voice changes, and sometimes upper airway obstruction.

However, beyond these parallels, the pharynx appears less likely than the larynx to be a driver of chronic neck pain and craniocervical dysfunction. There is much better scientific evidence for the involvement of the larynx in causing neck pain via MTD compensations, and in dysautonomia via the vagus nerve that supplies the larynx. For this reason, the PGP model assumes that comorbidities involving the pharynx are mere aggravators for the main disease pathway of MTD. Sensory and mitochondrial aspects of ME/CFS from existing research will be shown to be uniquely explained by the MTD hypothesis.
...
Abnormal breathing also affects blood pressure and perfusion by way of disturbed intrathoracic pressures. These mechanics tie back to musculoskeletal interactions: comorbid chest wall syndromes potentially related to laryngeal muscle overactivation in PGP, such as costochondritis and thoracic outlet syndrome (TOS), aggravate rib motion dynamics and encourage abnormal breathing. The lungs share space with the heart organ within the tight thoracic cavity and mechanically transfer compressive forces to it with each breath. Inappropriate ribcage and lung volume dynamics may exert maladaptive cyclical forces on the heart, distorting venous return and local perfusion anywhere in the body.

Taken together, dysautonomia within the PGP model is not an isolated feature but the autonomic expression of disordered breathing and vagal signaling. These disturbances to oxygen delivery and metabolism may ultimately result from known mitochondrial impairments central to energy depletion in ME/CFS, discussed in the next section.




breathing/heart interaction
[cite Sinus arrhythmia not necessarily benign, actually]

  Due to its type of sensing, the nature of the larynx is that it feels differently depending on whether the body is inhaling or exhaling, whether the lungs are full or empty, and perhaps even the timing of the heart. Laryngeal stretch sensors would necessarily fit this bill because they’re only activated when pressure is high. Suppose the act of breathing itself becomes painful, favoring only one of either inhalation or exhalation, which has a lopsided effect on breathing pattern and metabolism as the body slows one or the other to delay the pain.

Declaration: Fatigued, dysfunctional laryngeal stretch sensors create a pathological signal rhytmically since the stretch sensors are only active during part of the breath cycle.  This rhythmic errant signal is on the vagus nerve, a large vulnerable nerve, where dysfunctional neural cross-talk is possible that could disrupt HRV as seen in ME/CFS.  The waveforms of the heart and breathing are often synchronized as in RSA, or pathologically as in negative RSA. Investigation is therefore needed for ME/CFS as to whether HRV is disrupted with the breathing cycle via stretch sensors, in a rhythmic fashion disturing the heart waveform specifically due to the disturbed vagus breath signal waveform.
  Evaluate this via:
    nerve conduction and reflexes in the laryngeal area
    concurrent assessment of laryngeal muscle function and vagal tone
    the specific role of laryngeal stretch sensors in any cardiac signals over-represented in ME/CFS
    cardiac autonomic testing including RSA monitoring
          Testing for negative RSA would require detailed heart rate variability analysis synchronized precisely with respiration, typically during controlled breathing or tilt-table protocols in autonomic function labs. Such testing is feasible but not yet standard in ME/CFS research.
    Possible treatment:  Minimize the feelings of breathing and of change in breathing. Zigzag breathing (breathing in a sawtooth waveform) - as in keeping a constant derivative of air volume - but not at any different of a rate or depth than what feels good or would otherwise be needed if you weren’t trying to feel your breath.
  Evidence
    prior autonomic/vagal issues such as IBS predict much higher rate of ME/CFS development post EBV  https://pmc.ncbi.nlm.nih.gov/articles/PMC8959090/
    ME/CFS patients exhibit altered autonomic cardiac regulation generally characterized by reduced parasympathetic (vagal) tone and increased sympathetic activity, which could manifest in atypical RSA patterns including negative RSA. The variability and small effect sizes in heart rate variability studies to date, combined with differences in methodology and patient heterogeneity, make it difficult to pinpoint specific RSA abnormalities like negative RSA reliably across cohorts.
