...
ME/CFS is defined with a few hallmark features plus a shotgun pattern of comorbidities.  This common mental model of ME/CFS creates the impression among clinicians that it is mysterious, overcomplex, possibly a bad diagnosis, and of unclear treatment course of action.  To improve that situation, this work aims to demystify ME/CFS by bringing together causal links supported by the existing literature in a framework that is novel, highly plausible, and testable, which could outperform the current understanding.  One can infer the true shape of the ME/CFS mechanistic flow chart by testing whether candidate flows provide a reframing of ME/CFS that dramatically clarifies it as a disease, and whether their explanations and implied workings are consistent with established features of ME/CFS populations.

    Because doctors don't know the precise relationships of comorbidities, they aren’t articulated to patients, who stay mystified by what’s going on with their bodies. Many of those comorbidities can be confused for one another in how they subjectively feel, thus precise information doesn't make it back to clinicians.

    Furthermore, Intentional attempts to obfuscate the nature and mechanisms of MECFS for economic gain have caused great scandals in the past. 
    Confusion and even historic sabotage incidents have delayed the discovery that MECFS is essentially just small fiber neuropathy including its more obscure effects.  The reason it was discovered originally in the context of viral outbreaks is due to mitochondrial mechanisms that are now well understandable, even if not well known. 


    Clinicians are mostly outside the research world and are often ambivalent about the competing narratives of chronic illness, often favoring the easier dismissive explanations once ruling out acute illnesses they were trained more heavily for by extant medical schools. Those who do work in research work in relative silos of topics. Thus, part of the onus is on amateur patient researchers to make connections, who are not bound to restrictions in focus.

  patient-led consortia (e.g., Body Politic) were instrumental in framing “long COVID” as biologically credible when early narratives leaned psychosocial. That activism sparked academic recognition and NIH initiatives.

Our results, contrary to most modern research emphasis, show that almost every symptom and comorbidity of MECFS no matter how obscure can be explained as downstream of neural pathologies. These especially include pathology of the cranial nerves, and affect all small nerve fibers throughout the body. In short, SFN is the driver of most MECFS symptomatology. The original MECFS research was correct to focus on nerves and to include severe nerve disease cases in outbreaks. To demonstrate that this framing is consistent with modern discoveries of a mitochondrial basis for MECFS, we advance a new hypothesis that nerve cells are even more vulnerable than muscle tissues to mitochondrial dysfunction, and that once depleted of energy their local crashes correspond to (and produce) PEM episodes.
...
Some of the chronic pains that are plausibly produced downstream of cranial nerve SFN follow counterintuitive processes. Many involve correctable muscle activation pattern dysfunction.
...
There may be multiple systems in a tug-of-war. One is the simultaneous dysfunction of all positional stabilization (visual, vestibular, and proprioceptive) resulting in vertigo and upper body muscle guarding. Another is UARS. another is APD and intrathoracic sensitivity.
    ...
    Some locations strongly impacted by cranial nerve dysfunction are the neck and eye muscles, the larynx, the thoracic outlet, and the diaphragm.
...
The attempt described in this work begins by assuming one particular causation arrow exists in the graph. It takes as a given that there is a causal link from Small Fiber Neuropathy (SFN, commonly detectable in ME/CFS) to the voice and speaking condition called Muscle Tension Dysphonia (MTD).  Although voice conditions as subtle as MTD are given relatively little attention in chronic illness cases, there is a high rate of co-morbidity between MTD and ME/CFS that remains totally unexplained, and mostly unknown.  Neuropathy is one alternative explanations for why MTD occurs, but other alternatives exist and so that link is not fully understood. Discussions from the SFN side thus never include MTD, or consider it among lists of the more clinically important symptoms of SFN.  However, this example of MTD illustrates that a divide exists between the obvious classic symptoms of SFN versus the less intuitive consequences of SFN, which are expected to be widespread.  The fact that one of these strange SFN consequences appears often in ME/CFS implies that others might as well.  Thus begins a search for other comorbidities of ME/CFS that could instead similarly be demystified as unusual presentations of SFN.
        ...
        Add a note that before the first link I baked in as an assumption, there was another one that Voice and neck pain were by directionally dependent.
...
The evidence for local energy crashes specifically comes from the fact that mitochondria issues and SFN both co-occur in MECFS populations, as well as the observation that nerve cells in more energy hungry nerves get hit first in the disease. MQC explains it best because other mitochondria findings would result downstream and there are MQC findings already as well such as elevated pink one.
    ...
    The chronic illnesses small fiber neuropathy and MECFS often co-occur, although the latter is considered more complex and unexplained. This work presents the discovery that Small fiber neuropathy can fully explain MECFS when both its overt and covert consequences are considered, accounting for the whole constellation of ME/CFS symptoms unexpectedly well.
    Energy mechanisms within nerve cells explain the peroxisomal nature of MECFS crashes as well as the distribution pattern of affected areas. Energy crashes directly within nerves create clinically significant neuropathy, with or without frank loss of Nerve fibers or biopsy differences.

Remember to point out how MECFS research started as neurological before it lost the plot which means it was close to being about SFN and discovering energy crashes of nerves.
...
### Muscle Tension Dysphonia
    ...
    Muscle tension dysphonia‘s main purpose in this is to prove that with the loss of sensation in the airway it creates a situation where cognition load is inversely related to how much control you have over your lyrics. Therefore things like floods of visual stimulation are also able to distract the brain from controlling the airway leading to almost full-time motor problems there. There’s never enough control at moments of truly demandingly complex tasks, such as phonation.
...
```
                       [Post-Viral Effects]
                                ↓
[Microscopic Pathology, Systemic Microclots, Metabolic Compromise, MCAS*] (footnote)
                                ↓
...
[Systemic Muscle Disease]  [Targeted Disease of Metabolically Vulnerable Sensory Terminals]
                   ↓            ↓
    [PEM, Severe ME/CFS]  [ Laryngeal Nerves Tire Locally ]
                                ↓
...
Declaration 5: ME/CFS patients are, in effect, frozen in pain and maladaptive muscular postures driven by disrupted proprioceptive feedback and involuntary MTD, which together form a local paralysis.
...
The simple Pained Gasping Posture concept could help demystify well-established links to ME/CFS related chronic illnesses such as Cranio‑Cervical Instability (CCI) and Mast Cell Activation Syndrome (MCAS) and some frequently correlated traits. To the author’s knowledge, this is the first comprehensive attempt to explicitly and accessibly unify the entire ME/CFS symptom cascade. A single hypothesis integrates neuromuscular pathology and systemic physiological consequences. It demands critical scrutiny and collaborative research to further validate, refine, and translate its predictions into improved clinical care and patient outcomes. While some components overlap with prior literature or reflect limitations inherent to patient perspectives, this framework uniquely accounts for disparate features of ME/CFS including CCI, dysautonomia, mitochondria failure, and neural dysfunction. Using supporting evidence from the literature, each of those will now be recast as upstream and downstream comorbidities of MTD.

The model draws on patient lived experience that inspired its development. The author learned about MTD as a result of investigating why it was when moving their problematic neck joint in the direction of increasing pain, their airway and voice observably changed; a confirmed MTD diagnosis soon followed this revelation. Generally, ME/CFS anecdotes online abound with signs that certain pathology is local to the neck, that extended speaking is a common trigger, and that interventions for MTD bring relief [cite https://www.mdpi.com/2077-0383/14/14/4847] [cite https://pmc.ncbi.nlm.nih.gov/articles/PMC8906430/pdf/cjrt-2021-074.pdf ]. Patient-centered insights have uncovered musculoskeletal and neurological connections, suggesting underappreciated new directions for diagnosis and treatment, particularly as Muscle Tension Dysphonia is recognized as highly treatable with established interventions and muscle retraining.
...
The PGP model reframes longstanding approaches to structural findings such as Cranio‑Cervical Instability (CCI), because dysfunctional airway muscle activity has implications on spinal pain as well. PGP begins with laryngeal muscle overuse: chronic strain and fatigue of the small intrinsic muscles engaged in MTD, followed by exhaustion of the larger extrinsic laryngeal muscles. Per Henneman's size principle, the body recruits progressively larger muscles when smaller ones can no longer meet functional demands. The next larger muscles anatomically situated to be recruited to assist the larynx (and which are in fact involved in breath support during speech) include the trapezius, scalenes, and SCM [cite https://journals.sagepub.com/doi/10.1177/01455613211063239 ] - the same muscles that support and mobilize the craniocervical joint (CCJ).

This remarkable overlap suggests a potential causal flow from MTD to CCI. While the reverse relationship (CCI causing muscle tension and dysphonia) has been acknowledged, the forward direction—that vocal muscle overuse may promote functional instability of the CCJ—has scarcely been considered, despite clinical associations between chronic vocal injury to neck pain [cite https://journals.sagepub.com/doi/10.1177/01455613211063239]. The evidence points to a bidirectional relationship, warranting rigorous new clinical study.

As more muscles are recruited for basic breathing and speech, initial aches of the neck and head could give way to secondary consequences: Vascular compression, lowering cerebral perfusion or inducing local ischemia; cervical spine strain via uneven loads and degenerative wear; distortion of spinal cord and cranial nerve pathways; Cervical–Medullary Syndrome (CMS), a brain stem injury with autonomic consequences; breathing dysfunction, including sleep apnea; and so on, as shown in the flow diagram.  Downstream symptoms follow predictably from laryngeal fatigue and sustained “pained gasping posture.”

        The flowcharts show pathways that all encourage functional CCI to exist in MECFS through neuropathy, alone, without needing any genuine ligament laxity. Extreme care must be taken to rule out functional CCI before surgery on ligaments unless they are genuinely injured, because appearing longer on imaging may not mean that they are lax but merely under tension from these causes.

        Cranial nerve compression is widely hypothesized but is unrealistic as a mechanism because compression is inherently dynamic as the body moves, but many of the chronic symptoms are static in nature. What is more static and therefore more plausible is damage to the small fibers , rather than to the large fibers upstream. Either one could explain neuropathy, but the latter has been underestimated in likelihood.

        For lack of a better explanation such as this model, the only thing researchers could come up with to explain vagus dysfunction is compression, but that doesn’t explain the high frequency of cases since compression points should vary a lot and mostly not affect the nerve in a stereotypical partial impairment. Nor does it explain the timing of crashes since compression is much higher frequency and on or off. And it also completely overlook the involvement of all the other cranial nerves which is evident from symptoms, but not explainable by all of them being compressed simultaneously.

Chronic CCI cases are radically different from severe acute CCI, such as that caused by traumatic dislocation. The CCJ is structurally robust, destabilized only under high‑energy impacts (e.g. vehicle accidents, major falls) or predisposing conditions such as Ehlers‑Danlos Syndrome (EDS). Even maximal muscle contraction forces cannot induce ligamentous creep (permanent lengthening) overcome such osseous structures. In contrast, chronic CCI often presents “functionally,” with instability attributed not to frank ligament rupture but to disturbed neuromuscular control and abnormal cervical proprioception <sup><a name="cite11"></a>[11](#ref11)</sup>.

        Functional instability involves swaying because the body has lost sensation and is self stimulating to find some. Noxious sensations like slight nerve compression are still there, but the reassuring signals that the brain depends on are missing. Reassuring Sensations such as, the airway is open, or the head is balanced and the spine or muscles are at rest, or the swallowing muscles are sealed tight, or the eyes are in focus and level.


Declaration 6: Functional CCI (functional instability of the craniocervical joint) can be caused by Muscle Tension Dysphonia (MTD), because the muscle recruitment patterns for both coincide. Laryngeal recruitment competes with the fine neck posture motor control needed by the CCJ, which are often involved in compensation or spasm in CCI. This muscle overuse MTD pathway is why CCI is seen in ME/CFS.

The cervical proprioceptive system integrates visual, vestibular, cerebellar, and somatosensory signals. Deep cervical and suboccipital muscles contain dense muscle spindles critical for position sense [cite https://pmc.ncbi.nlm.nih.gov/articles/PMC11476954/ ]. As will be shown later, dysfunction of muscle spindle stretch sensors plausibly underlies both MTD and characteristic energy crashes of ME/CFS. Thus in the "functional" CCI variant, instability does not require ligaments to be damaged by high-energy impacts, or for unusual forces to even be real rather than merely perceived, but simply for the balance‑control system to become confused in its difficult task; head posture is mechanically analogous to balancing a bowling ball on a spring, so control signal distortion alone can lead to functional collapse.

Chronic neck muscle overactivation from MTD may not achieve the destructive forces seen in traumatic injury, but it nonetheless alters tissue loading, vascular perfusion, and neural signaling. Although muscle tension is not usually what precedes instability, in the case of an unsupported head, the forces are significant; gravity multiplies the effective load, plausibly exacerbating functional CCI and pain. In other orthopedic contexts like hip dysplasia, slow deformation from uneven muscle loading via ligament creep and bone remodeling is well recognized [cite https://pmc.ncbi.nlm.nih.gov/articles/PMC9251826/]. By analogy, persistent overload could aggravate functional CCI and secondary pain syndromes without causing overt structural damage. The clinical presentation in such cases may masquerade as structural involvement, with muscle overactivation and ligamentous lengthening potentially mimicking true injury or joint instability on examination via common diagnostic criteria used for CCI.

Declaration 7: Chronic muscle activation—such as with MTD—can transiently stretch ligaments, producing imaging findings that mimic pathological laxity. This raises the risk of misdiagnosis and unnecessary CCI surgeries. Forces are invisible on static imaging and difficult to ascertain even on advanced dynamic imaging. Images alone cannot distinguish functional elongation (via tension forces of muscle tone) from irreparable structural elongation. Surgical stabilization may artificially stiffen the system, but this does not prove the ligaments were at fault. Surgery is appropriate for severe impact‑induced disruption but potentially harmful in cases of functional instability. The literature acknowledges this distinction must be based on the totality of evidence for any given patient, not absolute proof from one data point.

Declaration 8: The definition of “functional” CCI may presently be granted to too few patients (typically only when overt neurological signs such as swaying are present). Conservative therapies, including voice therapy, should always be trialed in ambiguous CCI presentations before surgical consideration. Currently, referrals from CCI treatment to voice therapy are virtually nonexistent.

Declaration 9: Ligament laxity may be a red herring in many ME/CFS cases of CCJ dysfunction. Even when congenital laxity exists (e.g. EDS), it may act primarily as an aggravator rather than the root cause (often MTD, which is more treatable than EDS). Treatments that address neuromuscular and proprioceptive retraining—paralleling MTD therapy—may therefore be more appropriate than interventions targeting ligamentous integrity [cite https://pmc.ncbi.nlm.nih.gov/articles/PMC11476954/ ]. Likewise, popular attributions of CCI to "tech neck" or screen overuse may be overlooking the primary proprioceptive mechanism and opportunities to address it.

#### Posture

Posture is a difficult balance-control task using a sensory feedback loop. Similarly, MTD pathology is possible because speech depends on feedback from the larynx and hearing. Although normal phonation can proceed even while all sensory feedback is blocked, evidence indicates the feedback instead serves to calibrate persistent adjustments to vocal behaviors over time. Thus, consider that MTD is not just a fleeting reflex as observed under videostroboscopy (seen only during phonation or its anticipation), but a durable, maladaptive learned state [cite https://www.organscigroup.us/articles/doi10.17352-2455-1759.000065-aor.php]. The altered baseline continually shapes laryngeal dynamics even outside active speech, so any disruptive muscle recruitment (affecting neck and CCJ dynamics) would reasonably be chronic as well.

Thus emerges a broader theory: the maladaptive control state of MTD, once established, may extend beyond the larynx to involve other parts of the brain's more generalized systems of fine motor regulation. Among fine motor systems, articulation of the vocal muscles for speech and singing is among the most demanding feedback-driven control problems, via the "tonic servo-reflex system" within the larynx [cite https://www.organscigroup.us/articles/doi10.17352-2455-1759.000065-aor.php]. Besides voice, fine motor control sytems include global posture, breathing, cervical stabilization and spine health, and even the extraocular muscles, whose fatigue or signaling frequently triggers sensory overload and crashes in ME/CFS. Each one might take part in the dysfunctional state seen in MTD. All these sensitive control systems share a limited processing resource pool. As will be shown later, neurological systems that use feedback are also prone to early failure and exhaustion in mitochondrial damage, a hallmark of of ME/CFS pathophysiology. If these systems overdraw from their shared pool of finite reserves, then their failures may co‑occur—a phenomenon named here as Fine Motor PEM. Resting one fatigued subsystem in the fine motor category could help others recover. For example, it remains to be studied whether ME/CFS patients, who frequently experience visual sensitivity, can increase functional capacity by performing movements while resting the high-bandwidth visual signal through eye-blocking, which additionally quiets the vestibulo-ocular reflex.
...
#### Pharynx
  ...
  HSV can cause vagal nerve palsy with pharyngeal muscle dysfunction
            (constrictors)  https://pubmed.ncbi.nlm.nih.gov/8737789/
...
Declaration 11: Dysautonomia in ME/CFS is driven by breathing reflex impairment. Comorbid Muscle Tension Dysphonia and laryngeal nerve dysfunction trigger maladaptive reflexes intensely enough to overload autonomic pathways via the vagus nerve, to the point of cardiovascular deregulation and orthostatic intolerance.

Another comorbidity, Irritable Bowel Syndrome (IBS), could be explained as laryngeal disruption of the vagus nerve. Notably, the vagus continues directly from the larynx to the esophagus and intestines to manage digestion. Considering faulty “rest and digest” signaling or signal interruptions via maladaptive alarm states, the vagus provides a conduit for ME/CFS gastrointestinal disorders such as IBS<sup><a name="cite15"></a>(#ref15)</sup>. This explains recent findings correlating IBS with functional dysphonia<sup><a name="cite40"></a>(#ref40)</sup>. In new EBV infections, prior autonomic/vagal issues such as IBS predict much higher rate of progression to ME/CFS [cite https://pmc.ncbi.nlm.nih.gov/articles/PMC8959090/ ]. Further ME/CFS comorbidities such as viral inflammation or MCAS contribute disruptions to the gut barrier alongside other protective barriers (skin, blood–brain, bladder, and cardiovascular).
...
Declaration 14: Cyclic vagal dysfunction could create competition between breathing and HRV waveforms. This would appear as Respiratory Sinus Arrhythmia (RSA), or like the less ideal version negative RSA where the waveform relationship is flipped. Although these are considered benign, discussion continues, and it's possible that the disease ME/CFS changes their implications.

Declaration 15: Interthoracic pressure cycle differences in ME/CFS patients due to breathing abnormalities create another potential route to heart rhythm and arterial pressure issues.

Although the ME/CFS population has clear differences in cardiac metrics, it is an open question whether the ME/CFS population has higher rates of RSA or negative RSA, because of the difficulty of this measurement. It would require HRV analysis synchronized with respiration monitoring, and availability of autonomic labs and tilt tables is low. The small effect sizes in heart rate variability studies to date, combined with differences in methodology and patient heterogeneity, make it difficult to pinpoint RSA reliably across any cohort.

### Mitochondria Implications

    ROS / redox levels would be reversible.  The real "switch" I was trying to articulate is that once ME/CFS starts, it never goes away.  Including the coupled episodes/onsets of clinical symptoms / comorbidities concurrently.

Explaining ME/CFS with a universal model requires accounting not only for the vast array of symptoms and comorbidities, but also for the universal hallmarks of the disease. Even if Muscle Tension Dysphonia (MTD) can plausibly explain linked syndromes such as CCI, dysautonomia, and localized neck or thoracic pain, there remains unaddressed one constant hallmark feature across virtually all patients: Post-Exertional Malaise (PEM). Unlike regionally localized symptoms (such as Muscle Tension Dysphonia), PEM represents a systemic collapse in energy production. Since every patient experiences PEM, any unifying model must explain how the same process that disrupts neck and laryngeal function also independently triggers this whole‑body energy crash. Without an "all-or-nothing" disease process, the defining syndrome of ME/CFS could not consistently emerge; patients would be observed with the other symptoms but not PEM, which is not the clinical reality.

Therefore, there must exist a mechanism that can both locally attack laryngeal sensory nerves and systemically drive PEM crashes, leaving molecular biomarkers of dysfunction. The laryngeal hypothesis alone cannot account for this duality. A common molecular denominator is required, and one with bistable dynamics that naturally explain the all‑or‑nothing character of PEM. Mitochondrial quality control (MQC) is the most plausible fit.

Mitochondria are the energy producers of the cell. Far from the simplified textbook drawings, they number up to thousands per cell, particularly in energy‑demanding tissues such as neurons, sensory receptors, and muscle fibers. Cells turn over billions of molecules of ATP every single minute, a testament to how tightly life depends on accurate mitochondrial function; even small errors in regulation can ripple into catastrophic failures in balancing this energy “currency” across all cellular processes. In basic terms, mitochondria are "cells within a cell" proposed to have once been a separate bacteria subsumed by animal cells, akin to a civilization's domestication of animal herds to meet energy needs. In fact, mitochondria still partially retain their own genetic code and their own intrinsic immune systems, which trigger the outer cell into alarm states.
...
Viruses that enter a cell must navigate mitochondrial immunity as well as divert mitochondrial energy pathways for replication. Differing approaches to balance that production/detection tradeoff exist between viruses; Epstein‑Barr Virus, a known ME/CFS trigger, favors long‑term stealth by altering mitochondrial metabolism, while SARS‑CoV‑2 pushes cells into overdrive, prioritizing rapid replication over cell survival. In either case the objective is to hijack the mitochondria "farm" of the cell and spend the energy, and the outcome is a reprogramming of mitochondrial states that can persist long after virus clearance, via epigenetic changes or maladaptive immune responses. Chronic illness results.
    ...
    "some viruses like Varicella Zoster can actually use PINK1 to help them replicate by manipulating how cells break down mitochondria" [ cite https://pubmed.ncbi.nlm.nih.gov/38184594/ ]
...
Declaration 13: Post-exertional malaise and local neuromuscular dysfunction in ME/CFS are both well explained by mitochondrial quality control failure, specifically disruption of the PINK1–Parkin pathway. This system-wide breakdown could uniquely produce both the systemic “crash” of PEM and the selective vulnerability of high-demand sensory feedback nerves governing breathing and laryngeal reflexes implicated in MTD. This challenges the prevailing focus on oxidative stress and positions quality control failure as the central molecular event in ME/CFS pathogenesis.

If quality control failure indeed best describes the mitochondrial defect in ME/CFS, it reframes PEM crashes and inconsistent energy levels. The core problem may not be an absolute shortage of mitochondria or ATP, but a faulty internal “fuel gauge” (AMPK, mTOR, and energy‑sensing feedback). Cells rely on continuous feedback from their mitochondria to assess usable energy reserves. When this gauge is miscalibrated—because mitochondria are not of the expected health—cells may overestimate capacity, unexpectedly run out, and enter metabolic collapse or cell death. Indeed, the ME/CFS study of exertion intolerance has revealed measurable muscle cell loss and mitochondrial injury, comparable to that seen in certain primary muscle diseases<sup><a name="cite34"></a>(#ref34)</sup>.


(Remaining sections are too incomplete to include)
...
How exactly are QC changes a better fit for long lived nerve cells accumulating persistent dysfunction?
    Hard to reverse, never corrects itself, switch like.
...
Fibromyalgia has long been controversial, regarded as either psychological or “central sensitization.” The PGP model suggests:
    ...
    Pain arises from chronic recruitment of accessory muscles to substitute for laryngeal insufficiency.

    This generates diffuse tenderness in neck, chest, shoulder, and back musculature — the classic fibromyalgia tender points.

    Repeated microtrauma and ischemia establish a chronic pain state, even once the triggering vocal dysfunction is overlooked.

Clinically, this offers a physical substrate for fibromyalgia without requiring “mysterious” central sensitization models, while still explaining secondary neural sensitization.
...
Explaining some of the ME/CFS experience away as executive functioning issues is not the usual dismissal of the whole disease as psychogenic; in fact, it is plausible for executive functioning to be a manifestation of physical disease. In theory, chronically painful conditions could be an actual upstream cause of executive functioning issues, by way of necessary adaptations of attentional pathways to work around the constant pain.  This question of causality from physical disease to autism is not commonly asked in that direction.  There is discussion of the neuroinflammation of disease contributing to autism [cite https://www.healthrising.org/blog/2013/03/28/is-chronic-fatigue-syndrome-part-of-the-inflammatory-disorders-epidemic-autism-inflammation-autoimmunity-and-mecfs/], but not of the pain itself being causal.
...
Treatments and Implications
    ...
    (as mentioned) The PGP hypothesis proposes that being trapped in an uncomfortable posture is central and people with ME/CFS may experience far more chronic pain than is recognized - or even than they themselves realize, since pain has become their baseline - while also explaining the brain fog and concentration difficulties frequently reported.
...
ME/CFS affects a vast portion of the global population, especially those exposed to Epstein-Barr Virus (EBV) - the unmitigated worldwide problem better known as “mono.” Echoes of past neglect remain glaringly evident in today’s response to ME/CFS and other post-viral syndromes. In the late twentieth century, powerful institutions largely responded to ME/CFS outbreaks with deflection and dereliction of duty and coordinated spin - repeating the same patterns of neglect and institutional failure that had happened just prior in the AIDS crisis under Anthony Fauci’s leadership.<sup><a name="cite35"></a>(#ref35)</sup> We are now witnessing history repeat itself, with many of the same names and organizations, but in the context of a new pandemic.

COVID-19 continues to surge, despite official assurances that the crisis is over and that no further responsibilities exist, personally or nationally. These narratives have become more intense and insistent than ever - perhaps to compensate for the uncomfortable reality that SARS-CoV-2 is the most transmissible airborne virus in recorded history. We are told that COVID is now “mild,” but this claim is based largely on the statistical noise that follows when the most vulnerable have already died. In truth, mortality is not even the metric of interest for this new pandemic. Repeated, often silent reinfections are now known to drive Long COVID. Not a day has passed since 2020 without further scientific confirmations that Long COVID leads to vascular and organ damage, persistent viral reservoirs, and immune cell depletion. The result is often a chronic symptom pattern that closely mirrors ME/CFS - now affecting a much wider segment of the population.

Thus, the cycle of ME/CFS continues into the present day. Officials and influencers minimize the ongoing crisis, leaving outbreak victims in desperate need of answers and support. Even if help comes late, new understanding can still change lives.
...
<a name="ref17"></a>[17]. <sup>[a](#cite17a) [b](#cite17b)</sup>.  Dimmock, M., Lazell-Fairma, M. (2015). [Thirty Years of Disdain: How HHS and a Group of Psychiatrists Buried Myalgic Encephalomyelitis.](https://www.wucb.be/pdf/30yearsdisdainsummary.pdf)
...
<a name="ref29"></a>[29]. <sup>[a](#cite29a) [b](#cite29b) [c](#cite29c)</sup>.  Geraghty, Keith J., and Charlotte Blease. "[Myalgic encephalomyelitis/chronic fatigue syndrome and the biopsychosocial model: a review of patient harm and distress in the medical encounter.](https://www.researchgate.net/profile/Keith-Geraghty/publication/325314240_Myalgic_EncephalomyelitisChronic_Fatigue_Syndrome_and_the_Biopsychosocial_Model_A_Review_of_Patient_Harm_and_Distress_in_the_Medical_Encounter/links/5b34b913a6fdcc8506d77dd1/Myalgic-Encephalomyelitis-Chronic-Fatigue-Syndrome-and-the-Biopsychosocial-Model-A-Review-of-Patient-Harm-and-Distress-in-the-Medical-Encounter.pdf)" Disability and rehabilitation 41.25 (2019): 3092-3102.
...
<!--
    ...
    Deficiencies in mitochondrial enzymes like pyruvate dehydrogenase or levels of key cofactors such as CoQ10 and NADH are observed systemically, not just in isolated cells, indicating an ongoing system-wide disturbance.
    ...
    Key genes regulating mitochondrial metabolism and redox balance (including stress response and glucocorticoid signaling genes) are among those most commonly altered.
      https://www.tandfonline.com/doi/full/10.2217/epi-2017-0106
        Research by our group using DNA microarrays identified methylation differences >20% in 1192 CpG sites, corresponding to 826 genes, in peripheral blood mononuclear cells of ME/CFS patients [Citation12]. Interestingly, a significant increase in hypomethylation was observed in promoter and regulatory regions of immune genes compared with other gene classes. We next explored the interaction of differential DNA methylation with downstream immune response to environmental stress by specifically examining GC signaling. An in vitro examination of peripheral blood mononuclear cell GC sensitivity using a T cell mitogen revealed two ME/CFS subtypes: a GC-hypersensitive subtype that included patients with enhanced negative feedback to GCs, and a GC-typical subtype showing sensitivity similar to controls [Citation13]. Using statistical methods, GC sensitivity was isolated to methylation differences in 13 sites, mostly in noncoding regions but also in GST genes. By comparing both ME/CFS GC-sensitivity subtypes to healthy controls, we subsequently identified differential methylation in 4699 sites corresponding largely to cellular signaling and metabolic regulation as potential biomarkers for ME/CFS diagnosis. These functional differences in GC sensitivity could be mediated by DNA methylation modifications in specific T cell subsets, which have been observed in CD4+ T cells [Citation14], or the alteration of alternative splicing patterns of GR, possibly through changes in the DNA methylation patterns of the various alternative exon promoters in the gene encoding GR (NR3C1) [Citation15].
      https://www.meresearch.org.uk/resetting-me-cfs-with-epigenetics-part-1/


  History Section

      Mix with toned down version

      Yellow Fever book for tradition of top-down minimizing of plagues
      ...
      Current Day Parallels
            ...
            OSHA mandate scandal and timeline
  ...
  Can you spot each major or minor scientific error in this writing?
